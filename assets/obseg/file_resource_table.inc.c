...
// Host note: byte-array resource symbols intentionally decay to u8 *.
// Taking &array produces u8 (*)[] and misstates the table's pointer contract.
...
struct fileentry file_resource_table[] = {
    ...
    {CARD_BOX4_LG, "Pcard_box4_lgZ", Pcard_box4_lgZ},
    {CARD_BOX5_LG, "Pcard_box5_lgZ", Pcard_box5_lgZ},
    {CARD_BOX6_LG, "Pcard_box6_lgZ", Pcard_box6_lgZ},
