            ...
            if (handptr->weapon_action_state == GUN_ANIM_STATE_FIRE)
            {
                ...
                if ((getPlayerCount() == 1) || ((checkGamePaused() == 0) && (g_CurrentPlayer->mpmenuon == 0)))
                {
                    if (sp1B4 != 0)
                    {
                        ...
                        if ((handptr->field_A48 != NULL)
                            && (sndGetPlayingState(handptr->field_A48) != 0))
                        {
                            sndDeactivate(handptr->field_A48);
                        }
                        ...
                        if (bondwalkItemGetSound(var_s1) != 0)
                        {
                            ...
                            else if (handptr->field_A48 == NULL)
                            {
            ...
            if (weapon_right != ITEM_UNARMED)
            {
                    ...
                    && !bondwalkItemCheckBitflags(weapon_right, WEAPONSTATBITFLAG_HIDE_AMMO_DISPLAY))
                {
                    ...
                    if (imageoffset_r != 0)
                    {
                        ...
                        gdl = set_rgba_redirect_generate_microcode(gdl, (sImageTableEntry *)imageoffset_r, (getPlayer_c_screenleft() + getPlayer_c_screenwidth()) - (f32)rightx, -1.0f,
#if defined(VERSION_EU)
                        ...
                        textwidth_r = ((sImageTableEntry *)imageoffset_r)->width;
                    }
            ...
            if (weapon_left != ITEM_UNARMED)
            {
                    ...
                    && !bondwalkItemCheckBitflags(weapon_left, WEAPONSTATBITFLAG_HIDE_AMMO_DISPLAY))
                {
                    ...
                    if (imageoffset_l != 0)
                    {
                        ...
                        gdl = set_rgba_redirect_generate_microcode(gdl, (sImageTableEntry *)imageoffset_l, getPlayer_c_screenleft() + (f32)leftx, -1.0f,
#if defined(VERSION_EU)
...
#endif
                            ammo_related[ammotype].IconYOffset, 1);
                        textwidth_l = ((sImageTableEntry *)imageoffset_l)->width;
                    }
    ...
    if (item != ITEM_UNARMED)
    {
            ...
            && !bondwalkItemCheckBitflags(item, WEAPONSTATBITFLAG_HIDE_AMMO_DISPLAY))
        {
            ...
            if (imageoffset != 0)
            {
                ...
                // Draw the ammo icon
#if defined(VERSION_EU)
                gdl = set_rgba_redirect_generate_microcode(gdl, (sImageTableEntry *)imageoffset, 200.0f, 208.0f, (viGetViewTop() + viGetViewHeight()) - 30, 0, ammo_related[ammotype].IconYOffset, 1);
#else
                gdl = set_rgba_redirect_generate_microcode(gdl, (sImageTableEntry *)imageoffset, 200.0f, 180.0f, (viGetViewTop() + viGetViewHeight()) - 20, 0, ammo_related[ammotype].IconYOffset, 1);
#endif

                textwidth = ((sImageTableEntry *)imageoffset)->width;
            }
